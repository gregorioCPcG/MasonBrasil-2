#N1_novoformato_recodificaçõesIniciais

# Observação inicial 
#Repeti tudo que foi feito em relação às demais variáveis 
# na versão primeira (anpocs 46) do trabalho

# a unica alteração será na variável indep que usará outro procedimento 

# se veio aqui da anpocs, entenderá. 
#Caso veio parar já em uma versão posterior ignore a mensagem acima e siga normalmente
